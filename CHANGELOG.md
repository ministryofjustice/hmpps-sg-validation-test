...
See PR [#479](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/479)
...
See PR [#481](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/481)
...
See PR [#383](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/383)
...
See PR [#474](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/474)
...
See PR [#441](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/441)
...
See PR [#439](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/439)
...
See PR [#435](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/435)
...
PR: [#412](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/412) and
PR: [#414](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/414). We also updated the documentation
...
can be found in PR: [#413](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/413) and
PR: [#415](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/415).
...
PR: [#388](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/388) and PR: [#378](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/378)
...
PR: [#377](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/377)
...
PR: [#388](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/388)
...
PR: [#375](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/375)
...
PR: [#365](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/365)
...
PR: [#352](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/352)

---

**February 29th 2024** – Use same node version for outdated check and security scan. This currently defaults to node 16

PR: [#321](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/321)

---

**February 15th 2024** – Move over to use Debian 12 based image (bookworm)

PR: [#316](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/316)
...
PR: [#297](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/297)
...
PR: [#274](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/274)

---

**November 29th 2023** – Use in-memory token store when developing locally

PR: [#273](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/273)

---

**November 6th 2023** – Add HMPPS Manage Users API to health checks

PR: [#255](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/255)
...
PR: [#252](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/252)
...
PR: [#249](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/249)
...
PR: [#247](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/247)
...
PR: [#238](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/238)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/231)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/212)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/197)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/178)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/172)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/170)
...
PR: [here](https://github.com/ministryofjustice/hmpps-sg-validation-test/pull/149)
